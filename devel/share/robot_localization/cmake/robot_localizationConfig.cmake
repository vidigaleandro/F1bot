...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/ubuntu/F1bot/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/ubuntu/F1bot/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/ubuntu/F1bot/install)
...
if(NOT "/home/ubuntu/F1bot/devel/include;/home/ubuntu/F1bot/src/robot_localization/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/F1bot/devel/include;/home/ubuntu/F1bot/src/robot_localization/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/F1bot/src/robot_localization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(robot_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "ekf;ekf_localization_nodelet;filter_base;filter_utilities;navsat_transform;navsat_transform_nodelet;ros_filter;ros_filter_utilities;robot_localization_estimator;ros_robot_localization_listener;ukf;ukf_localization_nodelet;/usr/lib/arm-linux-gnueabihf/libGeographic.so;yaml-cpp")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/F1bot/devel/lib;/home/ubuntu/F1bot/devel/lib;/opt/ros/melodic/lib)
