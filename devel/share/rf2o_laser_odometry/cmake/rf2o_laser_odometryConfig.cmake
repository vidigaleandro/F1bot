...
if("TRUE" STREQUAL "TRUE")
  set(rf2o_laser_odometry_SOURCE_PREFIX /home/ubuntu/F1bot/src/rf2o_laser_odometry)
  set(rf2o_laser_odometry_DEVEL_PREFIX /home/ubuntu/F1bot/devel)
  ...
  set(rf2o_laser_odometry_INSTALL_PREFIX /home/ubuntu/F1bot/install)
...
if(NOT "/home/ubuntu/F1bot/src/rf2o_laser_odometry/include;/usr/include/eigen3 " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/F1bot/src/rf2o_laser_odometry/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/F1bot/src/rf2o_laser_odometry/${idir}'.  ${_report}")
    endif()
